...
- [Replit: Array Filter](https://replit.com/@sheyna/NormalProfitableMoto#index.js)
- [React Separation of Concerns](https://kalleott.de/posts/project-webapp/styling-react)
